---
order: 12
title: krproject开发进展（十二）
article: false
date: 2013-12-22 16:06:18
---
...
![krproject开发日志](./assets/krproject-dev-log.png)

好了，牛就吹到了这儿了。老实记录下krproject首秀过程中暴露出的不足吧：

最大的问题俨然是出在[rapodbc](./krproject-develop-trace-4)身上，当时作为取代embedded sql的小工具，花了几天时间，但并没有详细测试过，尤其是插入和更新是有问题的……，修改完善后，发现又没有实现错误信息的获取，也是让我吃尽了苦头。代价就是最后性能测试没有得到完美表现，真是遗憾……！所以基础小工具的完善绝对是搭建大工程的最重要基础，一点不可马虎。
